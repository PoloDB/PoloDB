/**
 * This is borrowed from https://github.com/mongodb/mongo-rust-driver/blob/main/src/cmap/conn/wire/header.rs#L0-L1
...
impl OpCode {
    ...
    fn from_i32(i: i32) -> Result<Self> {
        match i {
            ...
            other => Err(
                anyhow!("Invalid wire protocol opcode: {}", other)
            ),
        }
    }
}
